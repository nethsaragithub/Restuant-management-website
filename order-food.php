...
$sql = "INSERT INTO orders(order_id,user_id,food_id,user_name, timestamp,Qty,Status) VALUES(?,?,?,?,?,?,?)";

$query  = $pdoconn->prepare($sql);

if ($query->execute([$order_id, $user_id, $food_id, $user_name, $timest, $Qty,$Status])) {
